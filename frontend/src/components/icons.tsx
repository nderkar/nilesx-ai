...
export function IconUsers(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M15.5 14.2c2.9.4 5 2.7 5 5.8" />
    </svg>
  );
}
...
export function IconTool(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M14.7 6.3a4 4 0 0 0-5.6 5.6l-6 6a1.4 1.4 0 0 0 2 2l6-6a4 4 0 0 0 5.6-5.6l-2.3 2.3-2-2Z" />
    </svg>
  );
}
...
export function IconBell(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M6 8a6 6 0 0 1 12 0c0 4.5 2 6 2 6H4s2-1.5 2-6" />
...
export function IconBarChart(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 21h18" />
      <rect x="6" y="11" width="3.5" height="8" rx="1" />
      <rect x="12.25" y="6" width="3.5" height="13" rx="1" />
      <rect x="18.5" y="14" width="3.5" height="5" rx="1" />
    </svg>
  );
}
